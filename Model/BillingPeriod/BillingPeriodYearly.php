...
class BillingPeriodYearly extends BillingPeriod
{
  ...
  public static function getNextBillableDate($fromDate , $amount = 1)      
  {
      ...
      // Keep it simple for now.
  		$nbDate = date('Y-m-d', strtotime("+$amount year", mktime(0, 0, 0, $month, $day, $year)));
...
error_log("From $fromDate ($year, $month, $day) i got " . $nbDate . " as next_billing");
    ...
    public function fraction($fromDate, $toDate)
    {
        ...
        $fraction = ($days / 365);
ererror_log("from: $fromDate, to:  $toDate, Diff: $diff_seconds Days:$days, Fraction: $fraction");
        return $fraction;
